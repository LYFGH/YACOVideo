...
#import <YACOVideo/UIView+ZFFrame.h>
#import <YACOVideo/UIImageView+ZFCache.h>
#import <YACOVideo/ZFUtilities.h>
#import <YACOVideo/ZFLoadingView.h>

@interface DouYinCollectionViewCell()
...
@implementation DouYinCollectionViewCell
...
- (void)setData:(PTBaseDataModel *)data {
    _data = data;
